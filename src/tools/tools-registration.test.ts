...
describe('registerAllTools', () => {
  ...
  it('should register deepseek_chat, deepseek_fim, deepseek_sessions, deepseek_review and deepseek_edit', () => {
    registerAllTools(mockServer as any, createMockClient(), store);
    ...
    expect(mockServer.tools.has('deepseek_review')).toBe(true);
    expect(mockServer.tools.has('deepseek_edit')).toBe(true);
  });
});
